...
//			app.alert("É necessario fechar todos os arquivos abertos para continuar");
//			}
//		else{
				//app.alert("Selecione o arquivo de destino (arquivo a ser corrigido)",true);
				//abre o arquivo para inserir a correção
				...
				if(docCorrigidoTEMP){
					var docErratasTEMP = app.browseForDoc({
						cFilenameInit: "Selecione o PDF que contém as erratas",
						cFSInit: "CHTTP",
					});
					//console.println(docCorrigidoTEMP.cPath);
					if(docErratasTEMP){
