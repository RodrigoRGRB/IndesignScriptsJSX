var  WJ_ImportFileAttachment05 = app.trustedFunction(function()
{
   app.beginPriv();

// *** Código adaptado ao tamanho dos PDFs gerados para o Edros - Feito por Fernanda Bernardes em 16/03/2012   *****
...
var marcaProva = "/I/Objetos/Scripts/AcrobatPDF/Prova/prova_edros.pdf";
...
var larguraDaPagina = 180; // define a largura padrão de todos os documentos
var bordaDireita = -((larguraMilimetros - larguraDaPagina) / 2);
bordaDireita = bordaDireita - 5; //margem em mm a partir da borda da página
bordaDireita = bordaDireita * 2.664; // Coverte milimetros para pontos
...
var numeroProva = app.popUpMenu("1ª prova","2ª prova","3ª prova","-","PDF Final");
...
for(i=0;i<numeroDePaginas;i++){
	...
	t.value = i;
	//t.text = "Aplicando prova na página " + (i + 1);
	t.text = "Aplicando '"+ numeroProva +"' na página "+ this.getPageLabel(i);
...
var DoCmdImportNamedAttach05 = 
"// Enter your JavaScript code here\n" +
"// Or select one or more JavaScrippets\n" +
"WJ_ImportFileAttachment05();"
//</JSCodeSnippet>

//<JSCodeSnippet name="ButtonObjDef">
var oButObjImportNamedAttach05 = 
{cName: "ImportNamedAttach05",
cExec: DoCmdImportNamedAttach05,
//oIcon: oIcon,
cMarked: "event.rc = false",
cTooltext: "Provas Edros",
nPos: 4};
