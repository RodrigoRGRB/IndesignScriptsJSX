...
function funcaoAjustaEquacao(graphics,paragrafo){
        ...
        */
         ...
         //largura
		arrayMyRectangle[1] = arrayMyRectangle[1]+(0.65*porcentagem/100);
		arrayMyRectangle[3] = arrayMyRectangle[3]-(0.7*porcentagem/100);
        
        //altura
        myRectangle.geometricBounds = arrayMyRectangle;
...
function funcaoAjustaLeading(graphics,paragrafo){
        ...
        if(proximaLinha.isValid){
           ...
           return 0;
           throw "Algumas equações não foram alinhadas";
           }
...
//Looping para todos os stories (Equação)
...
/*
//Looping para todos os stories (Leading)
for(s=0; s<documentoAtual.stories.length; s++){
