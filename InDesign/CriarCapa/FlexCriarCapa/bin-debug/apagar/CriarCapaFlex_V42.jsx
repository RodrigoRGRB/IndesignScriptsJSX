...
flashPlayer.gerarCapa2 = function(name, largura, altura, lombada, sangriaDirEsqTemp, sangriaSupInfTemp, isbnNumTemp, isbnX, isbnY,jpgFile,pdfFile,fecharIndesignTemp,isbnCorCtemp,isbnCorMtemp,isbnCorYtemp,isbnCorKtemp,isbnRotacaoTemp,seloPathTemp,seloXtemp,seloYtemp,criarEspiralTemp)
{
	...
	arquivoPDF = pdfFile;
    fecharIndesign = fecharIndesignTemp;
    isbnCorC = isbnCorCtemp;
    isbnCorM = isbnCorMtemp;
    isbnCorY = isbnCorYtemp;
    isbnCorK = isbnCorKtemp;
    isbnRotacao = isbnRotacaoTemp;
    seloPath = seloPathTemp;
    seloX = seloXtemp;
    seloY = seloYtemp;
    criarEspiral = criarEspiralTemp;
