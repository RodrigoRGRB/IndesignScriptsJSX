...
#include "FuncaoCriaCapaCarimboV1.jsx"
...
function main(){
	...
	//try{
                ...
                for(z=0;z<numeroDeCapas;z++){
				  ...
				  numeroPaginas = arrayDados[contadorArray++];
                    /*
                        alert(nome);
                        alert(capaLargura);
                        alert(capaAltura);
				...
				// Insere carimbo para a capa
                if(criarEspiral == "não"){
					carimbo = nome + " / Largura: " + capaLargura + " / Altura: " + capaAltura+ " / Lombada: " + capaLombada+ " / Paginas: " + numeroPaginas;
					}
				else{
					carimbo = nome + " / Largura: " + capaLargura + " / Altura: " + capaAltura+ " / Espiral / Paginas: " + numeroPaginas;
					}
...
/*
        ...
        //alert("aqui");
                ...
                //alert("cria espiral sim");
                
                //*************  ATUALIZA PROGRESS BAR ******************
                //myProgressPanel.pnl.text = "CAPA";
                myProgressPanel.pnl.myProgressBarLabel.text = "Inserindo arquivo da capa...";
                //alert( "Inserindo arquivo da capa...");
                //myProgressPanel.pnl.myProgressBar.value = 1;
                myProgressPanel.pnl.myProgressBar.value = myProgressPanel.pnl.myProgressBar.value+1;
                //*************  FIM ATUALIZA PROGRESS BAR ******************
                
				//win2.show();
                 //alert(templateEspiral);				
				...
				with(myDocument.documentPreferences){
					//pageWidth =((capaLargura*2)+capaLombada)+"mm";  
                       ...
                       pageHeight =  capaAltura;
                       //alert("altura largura:" + pageHeight + "-"+pageWidth);
				}
...
/*  
				...
				function graphics100(myGraphic){
                  ...
                  //alert(myRectangle1.item(0));
                  //alert(myRectangle2.item(0));
                  //alert(myRectangle1.item(0).graphics);
                  //alert(myRectangle2.item(0).graphics);
