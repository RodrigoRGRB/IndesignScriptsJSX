...
#include "placeActionV2.jsx"

#targetengine "session"

// ********Alterações em 15/10/2012 - Fernanda Bernardes   *****
//************************* REMOVER MENU ANTERIOR  *****************
var menuPrincipal = app.menus.item("$ID/Main");
try{
var mySpecialFontMenu = menuPrincipal.submenus.item("PDF - Poliedro");
...
try{
    var scriptMenu = app.menus.item("$ID/Main").submenus.item("PDF - Poliedro");
    scriptMenu.title;
}
catch (e){
    var scriptMenu = app.menus.item("$ID/Main").submenus.add("PDF - Poliedro");
}
...
//Criar Capa
var arquivo = new File( "/I/Objetos/Scripts/InDesign/MenuIndesign/Links/Criar_capa_link2.jsx");
