...
#include "FuncaoCriaCarimbov9.jsx"
#include "FuncaoExportarPDFv2.jsx"
#include "FuncaoPDFPlacer.jsx"
//#include "PDFBordas.jsx"
#include "funcaoBordasExatasv3.jsx"
#include "funcaoAlinhamentov3.jsx"
...
win.grupoProva.whichInfo.add ('item', "Original Ed.");
win.grupoProva.whichInfo.add ('item', "Prova Zero");
//fim add
...
win.grupoProva.whichInfo.onChange = function () 
	...
	/*
		...
		if(win.grupoProva.whichInfo.selection.text == "PDF Final - Erratas" || win.grupoProva.whichInfo.selection.text == "PDF Final"  || win.grupoProva.whichInfo.selection.text == "Prova Zero" ){
			win.grupoProva.info2.labelPDF.text = "PDF Preset: PROL";
			}
		else{
			win.grupoProva.info2.labelPDF.text = "PDF Preset: [PDF/X-4:2008]";
			}
