...
for(i=0;i<numeroDePaginas.length;i++){
	...
	if(PdfFinal == false){
				...
				var myX = (bounds[3]-bounds[1])-bordaDireita;
				var myY = (bounds[2]/2)+espacoTopo;

				var itemBounds = myPage.place(File(marcaProva), [myX, myY], undefined, false, false)[0];
				...
				alinhaTextFrame(myTextFrame,0,itemBounds.geometricBounds,true);
				...
				myParagraph.parentStory.appliedFont = app.fonts.item("Helvetica\tBold");
				myParagraph.parentStory.pointSize = 3;
				...
				alinhaTextFrame(myTextFrame2,3,itemBounds.geometricBounds,true);
		}
