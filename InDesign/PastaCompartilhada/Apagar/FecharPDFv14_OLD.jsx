...
//#includepath "/rede-sj/Dados/banco de imagens/Objetos/Scripts/InDesign/FecharPDF/"
...
if(win.grupoPaginas.paginas.radIntervalo.value == true){
	...
	try{	
                    //============== SINCRONIZA EDROS ============== 
                    //Se for PDF Final ou Erratas, chama o Sincroniza Edros
                    if(win.grupoProva.whichInfo.selection.text == "PDF Final - Erratas" || win.grupoProva.whichInfo.selection.text == "PDF Final"  ){
                        #include "/I/Objetos/Scripts/InDesign/Edros/EdrosLink.jsx"
                    }
                    else {
                        //Apaga metadados
                        app.activeDocument.metadataPreferences.documentTitle = "\n";
                    }
                    //==============================================
