...
function criaCarimbo(textoCarimbo,configuracaoPagina,myDocument,intervaloPDF){
...
//add Marcelo Acquilino - 26112018
if(numeroProva=="Original Ed."){
	espacoTopo += (constante);
	}

if(numeroProva=="Prova Zero"){
	espacoTopo += (constante);
	}
//fim do add
...
for(i=0;i<numeroDePaginas.length;i++){
	...
	if(PdfFinal == false){
				...
				*/
				...
				itemBounds = myPage.rectangles.add({geometricBounds:[myY, myX, myY+16, myX+5.7],cornerRadius:0});
				itemBounds.strokeColor = myDocument.swatches.item("Black");
				//itemBounds.fillColor = myDocument.swatches.item("None");
				itemBounds.fillColor = myDocument.swatches.item("Paper");
				...
				//Muda o textFrame para uma coluna
				...
				//Muda o textFrame para uma coluna
				myTextFrame3.textFramePreferences.textColumnCount = 1;
				
				myTextFrame3.textFramePreferences.ignoreWrap = true;
				...
				myTextFrame3.textFramePreferences.insetSpacing = [0,0,0,0];
				...
				//Muda o textFrame para uma coluna
				myTextFrame2.textFramePreferences.textColumnCount = 1;
				
				myTextFrame2.textFramePreferences.ignoreWrap = true;
				...
				myTextFrame2.textFramePreferences.insetSpacing = [0,0,0,0];
