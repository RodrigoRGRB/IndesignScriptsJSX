...
var novoDocumentoCriado = false;
	...
	var res =
		   ...
		   //Cria janela
		   var win = new Window (res,"Fechar PDF - Versão 2.0 - Fernanda Bernardes",);  
	...
	var win2 = new Window("palette", "Fechar PDF - Versão 2.0 - Fernanda Bernardes", [150, 150, 350, 200]); 
	this.windowRef = win2;
	win2.center();
...
win.grupoProva.whichInfo.onChange = function () 
	...
	/*
		...
		if(win.grupoProva.whichInfo.selection.text == "PDF Final - Erratas" || win.grupoProva.whichInfo.selection.text == "PDF Final" ){
			win.grupoProva.info2.labelPDF.text = "PDF Preset: PROL 2";
			}
        
		else{
			win.grupoProva.info2.labelPDF.text = "PDF Preset:  X1A - 205 x 275";
			}
...
if(win.grupoPaginas.paginas.radIntervalo.value == true){
	...
	try{	
				...
				if(win.grupoPredefinicao.whichInfo.selection.text == "Configurações do documento atual"){
					...
					criaCarimbo(carimbo,configuracaoPagina,app.activeDocument,intervaloPDF);
